...
for (j in 2:p)
{
  ...
  net1 <- neuralnet(X4 ~ ., data = Train_set(j,1), hidden = 3, learningrate = 0.01, stepmax = 1e+06)
  net2 <- neuralnet(X5 ~ .-X4, data = Train_set(j,2), hidden = 3, learningrate = 0.01, stepmax = 1e+06)
  net3 <- neuralnet(X6 ~ .-X5-X4, data = Train_set(j,3), hidden = 3, learningrate = 0.01, stepmax = 1e+06)
